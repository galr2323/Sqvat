...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Ingredient.food'
        raise RuntimeError("Cannot reverse this migration. 'Ingredient.food' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Ingredient.food'
        db.add_column('mainApp_ingredient', 'food',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mainApp.Food']),
                      keep_default=False)
